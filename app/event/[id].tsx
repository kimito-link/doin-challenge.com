  ...
  return (
    <ScreenContainer edges={["top", "left", "right"]} containerClassName="bg-background">
      ...
      >
        ...
        >
          <Pressable style={{ backgroundColor: colors.surface, borderRadius: 16, padding: 24 }} onPress={(e) => e.stopPropagation()} accessibilityRole="none" accessibilityViewIsModal={participationForm.showOneClickConfirm} importantForAccessibility="yes">
            ...
            <View style={{ flexDirection: "row", gap: 12 }}>
              ...
              <Pressable
                ...
                accessibilityState={{ disabled: participationForm.isSubmitting }}
