...
export default function RankingsScreen() {
  ...
  usePerformanceMonitor("Rankings", rankingsData.hasData, rankingsData.isInitialLoading, !rankingsData.hasData);
    ...
    <ScreenContainer containerClassName="bg-background">
      ...
      {rankingsData.isInitialLoading ? (
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => <RankingRow item={item} index={index} tab={rankingsData.tab} />}
          refreshControl={
            <RefreshControl
