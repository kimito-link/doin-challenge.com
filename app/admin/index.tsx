          ...
          <View className="flex-row flex-wrap gap-4 mb-6">
            {stats.map((stat, index) => (
              <Pressable
                ...
                accessibilityHint={stat.path ? "タップして詳細を表示" : undefined}
                style={({ pressed }) => ({
                  flex: 1,
                  minWidth: 150,
        ...
        <View className="mb-6">
          ...
          <View className="gap-3">
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel="システム状態を確認"
              accessibilityHint="DB接続、API状況を確認"
              style={({ pressed }) => ({
                flexDirection: "row",
                alignItems: "center",
                backgroundColor: colors.surface,
            ...
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel="カテゴリを管理"
              accessibilityHint="カテゴリの追加・編集・削除"
              style={({ pressed }) => ({
                flexDirection: "row",
                alignItems: "center",
                backgroundColor: colors.surface,
            ...
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel="チャレンジを管理"
              accessibilityHint="チャレンジの編集・公開設定"
              style={({ pressed }) => ({
                flexDirection: "row",
                alignItems: "center",
                backgroundColor: colors.surface,
