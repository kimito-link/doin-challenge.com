            ...
            {logs.map((log) => {
              ...
              return (
                <Pressable
                  ...
                  accessibilityRole="button"
                  accessibilityLabel={`${category.label}: ${log.message}`}
                      ...
                      <View className="mt-4 pt-4 border-t border-border">
                        ...
                        {!log.resolved && (
                          <Pressable
                            ...
                            accessibilityRole="button"
                            accessibilityLabel="このエラーを解決済みにする"
                            style={({ pressed }) => ({
