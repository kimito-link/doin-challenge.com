      ...
      >
        ...
        <View className="flex-row mb-4 bg-surface rounded-lg p-1 border border-border">
          <Pressable
            ...
            accessibilityLabel="削除済みタブ"
            accessibilityState={{ selected: activeTab === "deleted" }}
            style={({ pressed }) => [
              {
                flex: 1,
                paddingVertical: 10,
          ...
          <>
            ...
            <View className="flex-row gap-2 mb-4">
              <Pressable
                ...
                accessibilityRole="button"
                accessibilityLabel="選択した項目を復元"
                accessibilityState={{ disabled: bulkRestoreMutation.isPending }}
                style={({ pressed }) => [
                  {
                    flex: 1,
                    paddingVertical: 10,
              ...
              <Pressable
                ...
                accessibilityRole="button"
                accessibilityLabel="選択した項目を完全削除"
                accessibilityState={{ disabled: bulkDeleteMutation.isPending }}
                style={({ pressed }) => [
                  {
                    flex: 1,
                    paddingVertical: 10,
              ...
              <View className="gap-3">
                {deletedParticipations.map((p: DeletedParticipation) => (
                  <Pressable
                    ...
                    accessibilityRole="button"
                    accessibilityLabel={`${p.displayName || p.username || "匿名"}の参加情報`}
                    accessibilityState={{ expanded: expandedId === p.id }}
