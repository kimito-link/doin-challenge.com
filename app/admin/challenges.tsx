                ...
                <View className="p-4">
                  ...
                  <View className="flex-row gap-2 pt-3 border-t border-border">
                    <Pressable
                      ...
                      accessibilityRole="button"
                      accessibilityLabel={`${challenge.title}を表示`}
                      style={({ pressed }) => ({
                        flex: 1,
                        flexDirection: "row",
                        alignItems: "center",
                    ...
                    <Pressable
                      ...
                      accessibilityRole="button"
                      accessibilityLabel={challenge.isPublic ? `${challenge.title}を非公開に` : `${challenge.title}を公開する`}
                      accessibilityState={{ disabled: togglePublicMutation.isPending }}
                      style={({ pressed }) => ({
                        flex: 1,
                        flexDirection: "row",
                        alignItems: "center",
                    ...
                    <Pressable
                      ...
                      accessibilityRole="button"
                      accessibilityLabel={`${challenge.title}を削除`}
