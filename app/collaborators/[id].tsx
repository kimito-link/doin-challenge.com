      ...
      {isOwner && collaborator.role !== "owner" && (
        <View style={{ flexDirection: "row", marginTop: 12, gap: 8 }}>
          <Pressable
            ...
            accessibilityLabel={`権限を${collaborator.role === "co-host" ? "スタッフ" : "共同主催者"}に変更`}
            style={{
              flex: 1,
  ...
  return (
    ...
    >
      ...
      <View style={{ marginBottom: 16 }}>
        ...
        <View style={{ flexDirection: "row", gap: 8 }}>
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityLabel="共同主催者として招待"
            accessibilityState={{ selected: role === "co-host" }}
            style={{
              flex: 1,
          ...
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityLabel="スタッフとして招待"
            accessibilityState={{ selected: role === "moderator" }}
            style={{
              flex: 1,
      ...
      <Pressable
        ...
        accessibilityRole="button"
        accessibilityLabel="コラボレーターを招待"
        accessibilityState={{ disabled: isLoading || !twitterId.trim() }}
        style={{
...
export default function CollaboratorsScreen() {
  ...
  if (!isOwner) {
    return (
      <ScreenContainer className="p-4">
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
          <Text style={{ color: color.textMuted, fontSize: 16, textAlign: "center" }}>
            この機能は主催者のみ利用できます
          </Text>
          <Pressable
            onPress={() => navigateBack()}
