...
export default function InviteScreen() {
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = trpc.events.getById.useQuery({ id: challengeId }, { enabled: isValidId });
  ...
  const inviteUrl = inviteCode ? `https://douin-challenge.app/join/${inviteCode}` : null;
    ...
    return (
      <ScreenContainer containerClassName="bg-background">
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
          ...
          <Pressable onPress={() => navigateBack()} style={{ marginTop: 16, padding: 12 }}>
      ...
      <ScrollView>
        ...
        >
          <View style={{ alignItems: "center" }}>
            ...
            <Text style={{ color: color.textWhite, fontSize: 24, fontWeight: "bold", marginTop: 12 }}>友達を招待</Text>
        ...
        <View style={{ padding: 16 }}>
          ...
          >
            ...
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <Text style={{ color: color.textMuted, fontSize: 14, marginLeft: 4 }}>目標: {challenge.goalValue}人</Text>
            </View>
            {challenge.venue && (
              <View style={{ flexDirection: "row", alignItems: "center", marginTop: 4 }}>
                <MaterialIcons name="location-on" size={16} color={color.textMuted} />
                <Text style={{ color: color.textMuted, fontSize: 14, marginLeft: 4 }}>{challenge.venue}</Text>
              </View>
            )}
          </View>
        </View>
        ...
        <View style={{ padding: 16 }}>
          ...
          >
            ...
            <MaterialIcons name={showCustomForm ? "expand-less" : "expand-more"} size={24} color={color.textMuted} />
          </Pressable>
        ...
        {/* 招待リンク */}
        <View style={{ padding: 16 }}>
          <Text style={{ color: color.textWhite, fontSize: 16, fontWeight: "bold", marginBottom: 12 }}>招待リンク</Text>
          ...
          {inviteUrl ? (
            <>
              ...
              >
                <MaterialIcons name={copied ? "check" : "content-copy"} size={20} color={color.textWhite} />
                <Text style={{ color: color.textWhite, fontWeight: "600", marginLeft: 8 }}>
              ...
              >
                ...
                <Text style={{ color: color.textWhite, fontWeight: "600", marginLeft: 8 }}>シェアする</Text>
              </Pressable>
              ...
              >
                ...
                <Text style={{ color: color.textWhite, fontWeight: "600", marginLeft: 8 }}>Xでシェア</Text>
              </Pressable>
        ...
        {/* QRコード風のプレースホルダー */}
        <View style={{ padding: 16 }}>
          <Text style={{ color: color.textWhite, fontSize: 16, fontWeight: "bold", marginBottom: 12 }}>QRコード</Text>
          <View
            style={{
          ...
          >
            ...
            <Text style={{ color: palette.gray500, fontSize: 12, marginTop: 8 }}>スキャンして参加</Text>
          </View>
        </View>
