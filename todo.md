...
## v5.80 一覧ページのレイアウト崩れ修正

- [ ] 一覧ページの左側に縦表示されている問題を修正
- [ ] ホスト・キャバ嬢カテゴリを非表示にする（isActive=falseに設定）


## v5.80 視認性改善・ダークモード専用化

### アチーブメント画面の視認性改善
- [x] アチーブメントバッジの色を視認性の高い色に変更（コモン、アンコモン、レア、エピック、レジェンダリー）
- [x] アチーブメントカードの背景色と文字色のコントラストを改善
- [x] 進捗バーの視認性を改善

### 全画面の視認性チェック
- [x] 全画面で薄いグレー文字を明るい色に変更（#9CA3AF → #CBD5E0）
- [x] ボタン・バッジの色を視認性の高い色に統一

### ライトモード削除
- [x] ライトモード関連のコードを削除（ダークモード専用化）
- [x] ThemeProviderをダークモード固定に簡素化
- [x] テーマ設定画面をダークモード専用に更新


## v5.81 ランキング説明追加・用語改善・検索修正

- [x] ランキングが何のランキングかわかるように説明を追加
- [x] 「ホスト」を「主催者」などわかりやすい用語に変更
- [x] 初見ユーザーにもわかりやすいUI/UXに改善
- [x] 検索窓にキーワードを入れるとうまく動作しない問題を修正
- [x] バージョン履歴（リリースノート）ページを作成して外部から見えるようにする


## v5.82 レイアウト崩れ修正・カテゴリ修正
...
## v5.84 応援メッセージ・貢献度ランキングのサムネイル修正

- [x] 応援メッセージのサムネイル（プロフィール画像）が表示されない問題を修正（Twitter画像URLの変換を無効化）
- [x] 貢献度ランキングのサムネイルが表示されない問題を修正


## v5.85 緊急: イベント詳細ページが表示されない問題

- [ ] /event/2 にアクセスすると真っ白になる問題を修正


## v5.85 チャレンジ作成フォーム改善

- [x] チケット情報の数字入力をNumberStepperに変更（目標数値と同様の操作性）
- [x] 開催場所を必須項目に変更（バリデーションエラー追加）
