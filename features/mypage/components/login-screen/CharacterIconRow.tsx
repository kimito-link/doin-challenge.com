...
import { CharacterIconRow as BaseCharacterIconRow, type CharacterIconConfig } from "@/components/ui/character-icon-row";
...
export function CharacterIconRow({ marginBottom = 32 }: LoginCharacterIconRowProps = {}) {
  ...
  return (
    <>
      ...
      />
      <CharacterDetailModal visible={modalVisible} onClose={handleCloseModal} character={selectedCharacter} />
    </>
  );
}
