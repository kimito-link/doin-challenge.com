          ...
          <View key={index} style={styles.dayCell}>
            {day !== null && (
              <Pressable
                ...
                accessibilityState={{ selected: isSelected(day), disabled: isDateDisabled(day) }}
                style={({ pressed }) => [
                  styles.dayButton,
    ...
    <>
      ...
      >
        <Pressable
          ...
          accessibilityLabel="カレンダーを閉じる"
        >
          <Pressable onPress={(e) => e.stopPropagation()} accessibilityViewIsModal={showCalendar} importantForAccessibility="yes">
            <CalendarContent />
          </Pressable>
        </Pressable>
      </Modal>
