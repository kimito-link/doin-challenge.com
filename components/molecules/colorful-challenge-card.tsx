 ...
 */
export const ColorfulChallengeCard = memo(
  function ColorfulChallengeCard({
    challenge,
    onPress,
    numColumns = 2,
    width,
    ...
    return (
      <>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.progressContainer}>
                <Text style={styles.progressText}>
                  {challenge.currentValue.toLocaleString()} / {challenge.goalValue.toLocaleString()}
                  {unit}
                </Text>
        ...
        <Modal visible={showMenu} transparent animationType="fade" onRequestClose={() => setShowMenu(false)}>
          <Pressable accessibilityRole="button" style={styles.modalOverlay} onPress={() => setShowMenu(false)}>
            <View style={styles.menuModal} accessibilityViewIsModal={showMenu} importantForAccessibility="yes">
              ...
              <Pressable
                ...
                accessibilityHint="チャレンジの詳細を編集します"
                style={({ pressed }) => [styles.menuItem, pressed && { opacity: 0.7, transform: [{ scale: 0.97 }] }]}
                onPress={handleEdit}
              >
