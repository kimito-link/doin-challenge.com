...
export function AccountSwitcher({ visible, onClose }: AccountSwitcherProps) {
  ...
  return (
    ...
    >
      <Pressable style={styles.overlay} onPress={onClose} accessibilityRole="button" accessibilityLabel="モーダルを閉じる">
        <Pressable
        ...
        >
          ...
          <ScrollView style={styles.accountList} showsVerticalScrollIndicator={false}>
            ...
            {otherAccounts.map((account) => (
              <Pressable
                ...
                accessibilityState={{ disabled: switchingAccountId === account.id }}
                ...
                {switchingAccountId === account.id ? (
                  ...
                  <View style={styles.accountActions}>
                    <Pressable
                      ...
                      accessibilityRole="button"
                      accessibilityLabel={`${account.username}を削除`}
                      accessibilityHint="このアカウント情報を完全に削除します"
                      style={({ pressed }) => [
                        styles.removeButton,
          ...
          <Pressable
            ...
            disabled={isLoading}
            accessibilityRole="button"
            accessibilityLabel="別のアカウントでログイン"
