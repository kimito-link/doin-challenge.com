            ...
            return (
              ...
              >
                <Pressable
                  ...
                  accessibilityLabel={`${region.name}地方 ${regionTotals[region.id] || 0}人`}
                >
                  {blockContent}
                </Pressable>
              </Animated.View>
          ...
          {regionRanking.map((region, index) => {
            ...
            return (
              <Animated.View 
                ...
                accessibilityLiveRegion="polite"
                accessibilityLabel={`${index + 1}位 ${region.shortName} ${region.total}人`}
              >
        ...
        {selectedRegion && (
          <>
                        ...
                        return (
                          ...
                          >
                            <Pressable
                              ...
                              accessibilityRole="button"
                              accessibilityLabel={`${pref.name} ${pref.count}人`}
                            >
            ...
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel={`${selectedRegion.name}の参加者を見る`}
            >
