    ...
    <View style={{ marginTop: 24 }}>
      ...
      <View style={{ flexDirection: "row", marginBottom: 16, gap: 12 }}>
        <Pressable
          ...
          accessibilityLabel="譲りたいタブ"
          accessibilityState={{ selected: activeTab === "transfers" }}
          style={{
            flex: 1,
        ...
        <Pressable
          ...
          accessibilityRole="tab"
          accessibilityLabel="欲しいタブ"
          accessibilityState={{ selected: activeTab === "waitlist" }}
          style={{
            flex: 1,
      ...
      <View style={{ marginBottom: 20 }}>
        {activeTab === "transfers" ? (
          ...
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityLabel={isInWaitlist ? "待機リストから解除" : "待機リストに登録"}
            style={{
