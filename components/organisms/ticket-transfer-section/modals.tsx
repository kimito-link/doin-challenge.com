      ...
      {/* 枚数 */}
          ...
          <View style={{ flexDirection: "row", gap: 8, marginBottom: 16 }}>
            {[1, 2, 3, 4, 5].map((n) => (
              <Pressable
                ...
                accessibilityLabel={`${n}枚`}
                accessibilityState={{ selected: ticketCount === n }}
                style={{
                  flex: 1,
          ...
          <View style={{ flexDirection: "row", gap: 8, marginBottom: 16 }}>
            {(["face_value", "negotiable", "free"] as PriceType[]).map((type) => (
              <Pressable
                ...
                accessibilityRole="button"
                accessibilityLabel={priceTypeLabels[type]}
                accessibilityState={{ selected: priceType === type }}
                style={{
                  flex: 1,
          ...
          <View style={{ flexDirection: "row", gap: 12 }}>
            ...
            <Pressable
              ...
              disabled={isLoading}
              accessibilityRole="button"
              accessibilityLabel={isLoading ? "投稿中" : "投稿する"}
          ...
          <View style={{ flexDirection: "row", gap: 8, marginBottom: 20 }}>
            {[1, 2, 3, 4, 5].map((n) => (
              <Pressable
                ...
                accessibilityRole="button"
                accessibilityLabel={`${n}枚`}
                accessibilityState={{ selected: desiredCount === n }}
                style={{
                  flex: 1,
